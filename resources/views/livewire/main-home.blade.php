...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="cardMinimal">
            @foreach ($cardcontainers as $cardscontainer)
                @foreach ($cardscontainer as $cardcontainer)
                    @livewire('cards', [ 'selectTagsforcard' => &$selectTags, 'countstyles' => &$countstyles, 'cardselect' => $cardcontainer, 'allstylesforcard' => &$allstyles], key($cardcontainer['id']))
                @endforeach
            @endforeach
            ...
            <div class="cardMinimal">
                <div class="card" style="--background:{{$backgroundMain}}; --text:{{$textbuttonMain}};" >
                    <x-dynamic-component :component="$component_edit_text"
