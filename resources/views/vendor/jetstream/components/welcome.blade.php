<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-6 text-gray-500">
        Данный проект расчитан на то, чтобы у каждого была возможность вынести для себя интересные или полезныее ресурсы.
    </div>
</div>
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        ...
        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
               Здесь, будут храниться те самые интересные или полезные ресурсы, а именно ссылки на видео, сериалы, фильмы, книги и т.д. Без каких-либо ограничений. Это ваше персональное хранилище, ваше личное пространство. Все добавленные адреса и текст в данном разделе шифруются и видны лишь вам!
            </div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        ...
        <div class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
                Вы можете оставить нам любую обратную связь, будь она с печеньками или с говном. Мы выслушаем любые ваши предложения и пожелания. Так же будем рады любой помощи и поддержки.
            </div>
